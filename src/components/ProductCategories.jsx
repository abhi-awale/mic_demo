    ...
    <section className="bg-white py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="relative mb-12 flex items-center justify-center">
            ...
            <Link to="/products" className="absolute right-0 hidden items-center gap-2 font-semibold text-mic-primary transition hover:text-mic-primary-soft md:flex">
              View All Categories
              <ArrowRight size={18} />
            </Link>
          </div>
          ...
          <div className="mt-8 text-center md:hidden">
            <Link to="/products" className="inline-flex items-center gap-2 font-semibold text-red-600">
              View All Categories
              <ArrowRight size={18} />
            </Link>
          </div>
